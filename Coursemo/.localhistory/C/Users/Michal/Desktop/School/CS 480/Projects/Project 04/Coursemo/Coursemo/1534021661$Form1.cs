...
namespace Coursemo
{
  ...
  public partial class Form1 : Form
  {
    ...
    //
    // StudentsListBox_SelectedIndexChanged():
    //
    ...
    // FillEnrolledCourses():
    //
    // Retrieve courses that student is enrolled in
    // and fill UI list with them
    //
    ...
    //
    // FillWaitlistedCourses():
    //
    // Retrieve courses that student is waitlisted in
    // and fill UI list with them
    //
    ...
    //
    // CoursesListBox_SelectedIndexChanged():
    //
    ...
    //
    // FillCourseEnrollmentList():
    //
    // Retrieve students that are enrolled in the course
    // and fill UI list with them
    //
    ...
    // FillCourseWaitList():
    //
    // Retrieve students that are waitlisted in the course
    // and fill UI list with them
    //
    ...
    // UpdateStudentUi():
    //
    // Refresh all fields related to selected students
    ...
    // UpdateCourseUi():
    //
    // Refresh all fields related to selected course
    // to make sure it is up to date
    //
...
# on waitlist: {8}",
    ...
    //
    // Returns number of students enrolled in the given course
    //
    ...
    // GetCourseCapacity():
    //
    // Returns class size for the given course
    //
    ...
    // StudentWaitlisted():
    //
    // Returns true if student is waitlisted in the course,
    // false is returned otherwise
    //
    ...
    // GetStudentEmail():
    //
    // Returns student email for the given by parameter sid
    //
    ...
    //
    // GetFirstStudentFromWaitlist():
    //
    // Returns student Id (SID) of the first student that is on the
    // waitlist for the course 'cid' given by parameter
    //
    ...
    // So, if first student was enrolled in course X, and second student
    // was enrolled in course Y
    //
    // 0 - failure
    // 1 - success
    //
