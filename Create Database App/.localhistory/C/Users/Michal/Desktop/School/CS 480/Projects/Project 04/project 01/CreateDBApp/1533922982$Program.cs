...
namespace CreateDBApp
{
  class Program
  {
    ...
    // insertBikeTypes():
    // 
    private static void InsertBikeTypes(DataAccessTier.Data data)
    {
        using (var file = new System.IO.StreamReader("BikeTypes.csv"))
        {
            ...
            {
                //
                // insert bikeTypes from .csv file
                //
                ...
                string sql = string.Format(@"
                    INSERT INTO BikeType (BikeDescription, HourlyPrice)
                    VALUES ('{0}', {1});
